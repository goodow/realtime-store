...
J2OBJC = $(J2OBJC_DIST)/j2objc --prefixes src/main/resources/j2objc/package-prefixes.properties \
  --mapping src/main/resources/j2objc/method-mappings.properties
...
$(M2_REPO)/com/google/gwt/gwt-elemental/2.5.1/gwt-elemental-2.5.1.jar:$(M2_REPO)/com/google/gwt/gwt-user/2.5.1/gwt-user-2.5.1.jar' \
	    `cat $(SOURCE_LIST)` ; \
	fi
